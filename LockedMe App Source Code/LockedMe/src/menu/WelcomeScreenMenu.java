...
public class WelcomeScreenMenu extends Menu {
	...
	public void displayMenu() {
		...
		String menuText = "****** Select any option number from below and press Enter******";
	...
	public void inputHandler(String inputOption) {
		AppHandler.changeMenu(Integer.parseInt(inputOption));
